...
!    at least one of R, S and T is either 0.0E+00 or 1.0.  BOUND_RST has 
!    the form:
!
!    subroutine bound_rst ( r, s, t, i, xi )
!
...
!
    call bound_rst ( 0.0E+00, s, t, i, x0st )
    call bound_rst ( 1.0E+00, s, t, i, x1st )
    call bound_rst ( r, 0.0E+00, t, i, xr0t )
    call bound_rst ( r, 1.0E+00, t, i, xr1t )
    call bound_rst ( r, s, 0.0E+00, i, xrs0 )
    call bound_rst ( r, s, 1.0E+00, i, xrs1 )
!
!  Interpolate the I-th coordinate component of the interior point.
!
    call blend_123 ( r, s, t, x000, x001, x010, x011, x100, x101, x110, x111, &
...
subroutine rblock_print ( l, m, n, a, title )
!
!*******************************************************************************
!
