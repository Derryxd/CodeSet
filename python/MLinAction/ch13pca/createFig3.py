...
myDat = loadtxt('testSet3.txt')
lowDDat,reconDat = pca.pca(myDat[:,0:2],1)
label0Mat = lowDDat[nonzero(myDat[:,2]==0)[0]] #get the items with label 0
label1Mat = lowDDat[nonzero(myDat[:,2]==1)[0]] #get the items with label 1
label2Mat = lowDDat[nonzero(myDat[:,2]==2)[0]] #get the items with label 2
